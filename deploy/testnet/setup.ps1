...
Write-Host "  Website:     basalt.foundation"
Write-Host "  Testnet:     testnet.basalt.foundation"
Write-Host ""
Write-Host "  Both are accessible via your Cloudflare Tunnel (no open ports)."
