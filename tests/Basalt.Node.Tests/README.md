...
Unit tests for the Basalt node: configuration, message handling, validator setup, slashing integration, mainnet guards, solver manager, and solver scoring. **88 tests.**
