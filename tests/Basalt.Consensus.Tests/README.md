...
Unit tests for Basalt consensus: BFT state machine, validator set, staking, slashing, view changes, pipelined consensus, and weighted leader selection. **118 tests.**
